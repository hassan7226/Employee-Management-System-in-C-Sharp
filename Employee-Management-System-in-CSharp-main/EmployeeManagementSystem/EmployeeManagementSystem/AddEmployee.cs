...
namespace EmployeeManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=LENOVO-T490;Initial Catalog =MAINPROJECT;Integrated Security=True;TrustServerCertificate=True;");
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\\LENOVO-T490\Documents\EmployeeManagementSystem\", addEmployee_id.Text.Trim() + ".jpg");

                                /*string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
                                string directoryPath = Path.Combine(baseDirectory, "EmployeeImages");
...
namespace EmployeeManagementSystem
{
    public partial class AddEmployee : UserControl
    {
        ...
        //Data Source = LENOVO - T490; Initial Catalog = MAINPROJECT; Integrated Security = True; Trust Server Certificate=True
                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\LENOVO-T490\Documents\EmployeeManagementSystem\", addEmployee_id.Text.Trim() + ".jpg");
